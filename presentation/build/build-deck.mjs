...
<section class="s title">
  ...
  <p class="title-foot">Centre Espoir de Gatineau<span class="dot">·</span>wps.davidhatin.com</p>
</section>`);
  ...
  <div class="split">
    ...
    <div class="col shot-col">
      <div class="sms">
        ...
        <p class="bubble">Bonjour Daniel (Église Nouvelle Vie de Gatineau). Surplus alimentaire aujourd’hui au Centre Espoir : Plateaux de sushis et salades, 8 lot(s). Réserver&nbsp;: <span class="link">wps.davidhatin.com/o/1/…</span></p>
...
<section class="s join">
  <div class="mid">
    ...
    <p class="center"><a class="cta" href="https://wps.davidhatin.com/demande">wps.davidhatin.com/demande</a></p>
